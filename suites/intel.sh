...
CHECKS="phpquick php-obfuscated-loader php-threat-intel wp-campaign-intel js-threat-intel wp-db-malware external-yara wp-wordfence-intel wp-patchstack-intel wp-vulnerabilities"
