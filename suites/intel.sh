#!/usr/bin/env bash
RUN_NAME=intel
RUN_DESC="focused malware campaign + JavaScript/database + vulnerability intelligence"
...
CHECKS="phpquick php-obfuscated-loader wp-campaign-intel js-threat-intel wp-db-malware wp-wordfence-intel wp-patchstack-intel wp-vulnerabilities"
