...
RUN_DOES="Runs the complete local security suite, including recursive permissions, deep PHP/image inspection, PHP/JavaScript/campaign/database-malware intelligence, optional external YARA rules, official integrity checks, optional Wordfence/Patchstack/WPScan vulnerability intelligence, and database maintenance."
