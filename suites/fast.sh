...
CHECKS="host-persistence filesystem-security htcheck confcheck php-runtime phpcheck phpquick php-obfuscated-loader sensitive-files wp-access wp-core wp-root wp-plugins wp-themes wp-uploads wp-db"
