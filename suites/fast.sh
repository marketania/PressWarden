...
CHECKS="host-persistence filesystem-security htcheck confcheck php-runtime phpcheck phpquick php-obfuscated-loader wp-campaign-intel js-threat-intel sensitive-files wp-access wp-core wp-root wp-plugins wp-themes wp-uploads wp-db wp-db-malware"
