...
RUN_DOES="Runs routine persistence, filesystem, configuration, PHP, malware, JavaScript/campaign intelligence, integrity, plugin/theme, upload, access, WordPress policy, and lean database checks."
...
CHECKS="host-persistence filesystem-security htcheck confcheck php-runtime phpcheck phpquick php-obfuscated-loader php-threat-intel wp-campaign-intel js-threat-intel sensitive-files wp-access wp-settings wp-core wp-root wp-plugins wp-themes wp-uploads wp-db wp-db-malware"
